...
import VendorSideBar from "../../components/VendorSideBar"; // Ensure VendorSideBar is imported
      ...
      <section className="flex flex-col w-full p-6 md:p-10">
        ...
        <div className="mt-6 flex flex-col lg:flex-row bg-white rounded-lg shadow-md overflow-hidden h-full">
          ...
          <div className="w-full lg:w-1/3 border-r bg-gray-100">
            ...
            >
              {loading
                ? [...Array(5)].map((_, idx) => <ChatRoomSkeleton key={idx} />)
                : chatRooms.map((room) => (
                    <li
                      key={room.id}
              ...
              <Typography variant="h6">
                ...
                {selectedChatId
                  ? (() => {
                      ...
                      if (room) {
                        return fullName === room.sender_name
                          ? room.receiver_name
                          : room.sender_name;
                      }
                      return "Customer"; // Fallback if no room found
                    })()
                  : "Customer"}{" "}
                {/* Default fallback */}
              </Typography>
