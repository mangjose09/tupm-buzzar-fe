            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
              ...
              <div className="w-full">
                <Input
                  ...
                  placeholder="e.g., 9987654321" // Placeholder without +63
                  {...register("contactNumber", {
                    required: "Contact number is required",
                    setValueAs: (value) => `+63${value.replace(/^(\+63)/, "")}`, // Ensure the +63 is always included
                    pattern: {
                      value: /^\+63\d{10}$/, // Ensure it matches the format +63XXXXXXXXXX
                      message:
                        "Contact number must be in the format +639XXXXXXXXX",
                    },
                  })}
                  defaultValue="+63" // Default value is set to +63
