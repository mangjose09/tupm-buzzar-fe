...
const MENUS = [
  { label: "Dashboard", path: "/vendor/dashboard", icon: HomeIcon },
  { label: "Products", path: "/vendor/products", icon: ShoppingBagIcon },
  { label: "Orders", path: "/vendor/orders", icon: ClipboardDocumentIcon },
  { label: "Chats", path: "/vendor/chats", icon: ChatBubbleBottomCenterTextIcon},
  {
    label: "Store Profile",
    path: "/vendor/store-profile",
    icon: UserCircleIcon,
  },
  { label: "Settings", path: "/vendor/settings", icon: Cog6ToothIcon },
  // { label: "Help", path: "/vendor/help", icon: QuestionMarkCircleIcon },
  { label: "Logout", icon: ArrowRightEndOnRectangleIcon, action: "logout" }, // Add action instead of path
];
