...
const Footer = () => {
  return (
    <footer className="relative w-full bg-[#FFB25A] ">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 sm:grid-cols-2 lg:grid-cols-5">
          <div className="col-span-1 md:col-span-2  w-full flex flex-col gap-y-2">
            <Typography
              variant="h2"
            ...
            <Typography
              variant="small"
              color="white"
              className="text-left font-normal cursor-default"
            >
            ...
            <Typography
              ...
              variant="small"
              color="white"
              className="text-left font-normal hover:text-blue-gray-800"
            >
          ...
          {SITEMAP.map(({ title, links }, key) => (
            <div key={key} className="w-full">
              <Typography
                variant="small"
                color="blue-gray"
                className="cursor-default mb-4 font-bold uppercase opacity-50"
              >
                {title}
              </Typography>
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} Buzzar. All Rights Reserved.
          </Typography>
